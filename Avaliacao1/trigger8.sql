-- ------------------------------------------------------------------------------------------------
-- TRIGGER QUE SALVA EM UMA TABELA AUXILIAR, CADA REGISTRO INSERIDO NA TABELA LOCALIDADES
-- ------------------------------------------------------------------------------------------------
...
INSERT INTO bk_localidades VALUES (NEW.id, NEW.praca, NEW.endereco, NEW.apelido);
RETURN NEW;
